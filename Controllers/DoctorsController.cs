...
namespace MedicineStock.Controllers
{
    public class DoctorsController : Controller
    {
        ...
        public DoctorsController(MedicineStockContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DoctorId,FirstName,LastName,Specialization,PhoneNumber")] Doctor doctor)
        {
